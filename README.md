...
Here are some better tagline options:

**Simple & Direct:**

- `respec: Generate OpenAPI specs from Go code without annotations`
- `respec: Annotation-free OpenAPI generation for Go`
- `respec: Zero-annotation OpenAPI specs from Go source code`

**Benefit-focused:**

- `respec: OpenAPI specs that stay in sync with your Go code`
- `respec: Generate OpenAPI specs by analyzing your Go code`
- `respec: Clean OpenAPI generation for Go APIs`

**Action-oriented:**

- `respec: Analyze Go code, generate OpenAPI specs`
- `respec: Turn Go APIs into OpenAPI specs automatically`

**Concise:**

- `respec: Code-first OpenAPI for Go`
- `respec: Smart OpenAPI generation for Go`

My top recommendation would be:
**`respec: Generate OpenAPI specs from Go code without annotations`**

It's clear, highlights the main benefit (no annotations), and tells you exactly what it does.

--

### Content

respec: A Static Analysis OpenAPI Generator for Go

there has to be a better tag line than this
